...
namespace mapback
{
    public class BackMapper
    {
        ...
        public BackMapper()
        {
            ...
            const string Filename = @"/Users/nikolai/Sync-Computing/ShuffleScripts/step3/reads.fasta";
            ...
            const string Filename2 = @"/Users/nikolai/Sync-Computing/ShuffleScripts/step2/outputkmers.fasta";
        ...
        public bool AnalyzeReads()
        {
            for (int i = 0; i < ONTreads.Count; i++)
            {
                ...
                ToFile = ListSimplifier.Simplify(AnalyzeRead((Sequence)ONTreads[i], 12, 1),3);
        ...
        public bool AnalyzeReadsP()
        {
            ...
            Parallel.For(0, limit, count =>
            {
                ...
                ToFile = ListSimplifier.Simplify(AnalyzeRead((Sequence)ONTreads[count], 12, 1), 3);

                if (ToFile.Count > 5)
                {
                    string filename3 = "/Users/nikolai/Sync-Computing/ShuffleScripts/step3/output/" + ONTreads[count].ID + ".txt";
