...
namespace mapback
{
    public class Refmaker
    {
        ...
        public Refmaker()
        {
            ...
            const string Filename = @"/Users/nikolai/Sync-Computing/ShuffleScripts/step1/human_modules.fasta";
            ...
            const string Filename2 = @"/Users/nikolai/Sync-Computing/ShuffleScripts/step1/dumps.fa";
        ...
        public bool MakeRef(Ranger R1, int kmerlength, int step)
        {
            ...
            for (int a = 0; a < kmers.Count;)
            {
                ...
                const string filename3 = "/Users/nikolai/Sync-Computing/ShuffleScripts/step2/outputkmers.fasta";
